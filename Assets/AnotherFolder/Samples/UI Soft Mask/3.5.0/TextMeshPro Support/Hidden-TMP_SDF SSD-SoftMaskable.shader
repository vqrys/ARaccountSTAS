Shader "Hidden/TextMeshPro/Distance Field SSD (SoftMaskable)" {
...
SubShader {
    ...
    Pass {
        ...
        #include "Assets/AnotherFolder/TextMesh Pro/Shaders/TMPro_Properties.cginc"
        #include "Assets/AnotherFolder/TextMesh Pro/Shaders/TMPro.cginc"
